...
NODE_DIRS := $(REPO_ROOT)/node_modules $(patsubst %/package.json,%/node_modules,$(PKG_JSONS))
...
$(NODE_INSTALL_DONE): $(REPO_ROOT)/package.json $(REPO_ROOT)/yarn.lock $(PKG_JSONS)
	cd $(REPO_ROOT) && yarn install
	touch $(NODE_INSTALL_DONE)
