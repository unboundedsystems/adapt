...
_See code: [dist/src/commands/deploy/destroy.js](https://github.com/unboundedsystems/adapt/blob/v0.1.0-next.1/dist/src/commands/deploy/destroy.js)_
...
_See code: [dist/src/commands/deploy/list.js](https://github.com/unboundedsystems/adapt/blob/v0.1.0-next.1/dist/src/commands/deploy/list.js)_
...
_See code: [dist/src/commands/deploy/run.js](https://github.com/unboundedsystems/adapt/blob/v0.1.0-next.1/dist/src/commands/deploy/run.js)_
...
_See code: [dist/src/commands/deploy/status.js](https://github.com/unboundedsystems/adapt/blob/v0.1.0-next.1/dist/src/commands/deploy/status.js)_
...
_See code: [dist/src/commands/deploy/update.js](https://github.com/unboundedsystems/adapt/blob/v0.1.0-next.1/dist/src/commands/deploy/update.js)_
...
_See code: [dist/src/commands/project/new.js](https://github.com/unboundedsystems/adapt/blob/v0.1.0-next.1/dist/src/commands/project/new.js)_
<!-- commandsstop -->
