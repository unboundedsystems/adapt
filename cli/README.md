...
_See code: [dist/src/commands/deploy/destroy.ts](https://gitlab.com/unboundedsystems/adapt/blob/v0.0.4/dist/src/commands/deploy/destroy.ts)_
...
_See code: [dist/src/commands/deploy/list.ts](https://gitlab.com/unboundedsystems/adapt/blob/v0.0.4/dist/src/commands/deploy/list.ts)_
...
_See code: [dist/src/commands/deploy/run.ts](https://gitlab.com/unboundedsystems/adapt/blob/v0.0.4/dist/src/commands/deploy/run.ts)_
...
_See code: [dist/src/commands/deploy/status.ts](https://gitlab.com/unboundedsystems/adapt/blob/v0.0.4/dist/src/commands/deploy/status.ts)_
...
_See code: [dist/src/commands/deploy/update.ts](https://gitlab.com/unboundedsystems/adapt/blob/v0.0.4/dist/src/commands/deploy/update.ts)_
...
_See code: [dist/src/commands/project/new.ts](https://gitlab.com/unboundedsystems/adapt/blob/v0.0.4/dist/src/commands/project/new.ts)_
<!-- commandsstop -->
