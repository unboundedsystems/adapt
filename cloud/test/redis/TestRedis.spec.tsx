...
class Final extends PrimitiveComponent<AnyProps> implements NetworkServiceInstance {
    ...
    hostname(_scope: NetworkScope) { return "redisHost"; }
    port() { return 1234; }
}
...
describe("MongoDB", function () {
    ...
    mochaTmpdir.all("adapt-cloud-redis");
    ...
    it("Should build a connectToInstance with REDIS_URI", async () => {
        const hand = handle();
        const orig = <TestRedis handle={hand} />;
