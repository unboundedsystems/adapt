...
import { buildGraphQLSchema, ResolverFactory, UnknownArgs } from "./converter";
import { validateSwagger2 } from "./swagger_validate";

const debug = db("adapt:cloud:swagger2gql");

function swagger2gql<ObjectT = unknown, Context = unknown, Args = UnknownArgs>
    (swaggerIn: string | object, getResolver?: ResolverFactory<ObjectT, Context, Args>) {
